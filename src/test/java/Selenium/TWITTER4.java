    ...
    public void example() throws IOException {
        ...
        while (i < 3) {
            ...
            for (int j = 0; j < reviews.size(); j++) {
                ...
                tweetText = driver.findElement(By.xpath(reviewIdXPath + "//div[@class=\"css-901oao r-18jsvk2 r-37j5jr r-a023e6 r-16dba41 r-rjixqe r-bcqeeo r-bnwqim r-qvutc0\" ]")).getText();
...
//               catch (Exception f){
//                   tweetLikes = "0";             }
                date = driver.findElement(By.xpath(reviewIdXPath + "//a[@class = \"css-4rbku5 css-18t94o4 css-901oao r-14j79pv r-1loqt21 r-1q142lx r-37j5jr r-a023e6 r-16dba41 r-rjixqe r-bcqeeo r-3s2u2q r-qvutc0\"]")).getAttribute("aria-label");
